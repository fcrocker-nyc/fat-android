        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              _paragraphView(8, 'Prepared & Multi-Ingredient Foods',
                  'A canned stew, a frozen pizza, or a chicken noodle soup is not a single-animal product, so FAT scores it in a separate Prepared / Multi-Ingredient lane. Species is read as a list of every meat, poultry, or seafood ingredient named. The per-animal categories — breed, farm, age at slaughter, feed, welfare, medicine, hormones — are marked “not applicable” in blue: no U.S. labeling regulation requires a prepared-food maker to disclose them for ingredient meat, so the gap belongs to the regulatory design, not the brand. Jurisdiction forks the same way catfish does on the seafood side: a product with enough meat (roughly 3% raw / 2% cooked) is USDA/FSIS-regulated and carries a legend plus an establishment number — which identifies the final assembler, not the slaughterhouse of the meat inside — while below those thresholds the product is FDA-regulated and legally carries neither mark. Voluntary claims like “made with organic chicken” still count and still earn their credibility tier.'),
            ],
          ),
        ),
      ),
