        ...
        Column(
          ...
          children: _intersperse(
            <Widget>[
              ...
              _categoryRow(10, 'Dietary Attributes & Additives',
                  appScored: true),
              _categoryRow(11, 'Medicine / Antibiotics / Chemicals',
                  appScored: true),
              _categoryRow(12, 'Age at Harvest', appScored: true),
              _categoryRow(13, 'Enforcement & Compliance', appScored: true),
              _categoryRow(14, 'Supply-Chain Intermediaries', appScored: true),
              _categoryRow(15, 'Environmental Impact', appScored: false),
              _categoryRow(16, 'Economic Concentration / Foreign Ownership',
                  appScored: false),
            ],
            const SizedBox(height: 6),
          ),
