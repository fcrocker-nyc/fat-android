    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
            'Each scored disclosure category contributes its full weight when fully Known, 40% when Partial, 0 when Missing. The 16 category weights sum to 70 — the disclosure pillar: Animal Welfare 8; Feed 6 and Organic 6; Farm / Ranch 5 and Medicine 5; Breed 3 and Brand 3; Supply-Chain Intermediaries 2; the other eight categories 4 each. Credibility is the other 30 points, averaged across the categories the label actually addressed.',
    ...
    return Column(
      ...
      children: [
        ...
        Column(
          ...
          children: _intersperse(
            <Widget>[
              _categoryRow(1, 'USDA / FSIS Required Basics',
              ...
              _categoryRow(6, 'Age at Slaughter', appScored: true),
              ...
              _categoryRow(10, 'Feed', appScored: true),
              _categoryRow(11, 'Animal Welfare', appScored: true),
              _categoryRow(12, 'Medicine / Antibiotics', appScored: true),
              _categoryRow(13, 'Hormones', appScored: true),
              _categoryRow(14, 'Quality / Palatability', appScored: true),
